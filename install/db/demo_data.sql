...
(144, 1264779082, 1264779096, 12, 0, 1, 5, 0, 'This task was added realy quick', '<p>A very quick task</p>', 12, 12, 1265383882, 1264779082, 1265383882, 0, 26, 3, 7, 3600, 1, 0, 1),
...
(5, 107, 'panelwidgets:daytracks', 5),
(6, 107, 'general:use', 4),
(7, 107, 'general:use', 5),
(8, 126, 'account:setLanguage', 5),
(9, 126, 'general:use', 4),
(10, 126, 'general:use', 5),
...
(56, 126, 'account:setLanguage', 4),
(57, 126, 'account:setPassword', 5),
(58, 126, 'panelwidgets:profilemodules', 5),
(59, 126, 'panelwidgets:profilemodules', 4),
...
(65, 104, 'event:add', 1),
(66, 104, 'event:assignOthers', 1),
(67, 104, 'general:use', 1),
(68, 105, 'comment:sendAsEmail', 1),
(69, 105, 'comment:requestFeedback', 1),
(70, 105, 'general:use', 1),
(71, 105, 'comment:editOwn', 1),
(72, 111, 'general:use', 1),
(73, 111, 'general:area', 1),
