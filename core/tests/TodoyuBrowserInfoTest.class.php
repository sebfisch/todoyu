...
/**
 * Test for: TodoyuBrowserInfo
 *
 * @package		Todoyu
 * @subpackage	Core
 */
class TodoyuBrowserInfoTest extends PHPUnit_Framework_TestCase {
	...
	/**
	 * @todo Implement testGetMajorVersion().
	 */
	...
	/**
	 * @todo Implement testGetBrowserLanguage().
	 */
