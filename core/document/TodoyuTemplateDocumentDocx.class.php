 ...
 * @subpackage	Core
 */
class TodoyuTemplateDocumentDocx extends TodoyuTemplateDocumentAbstract implements TodoyuTemplateDocumentIf {

	/**
	 * ODT content type
	 */
	private $contentType = 'vnd.openxmlformats-officedocument.wordprocessingml';
