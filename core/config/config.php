...
Todoyu::$CONFIG['SECURITY']['badHtmlTags'] = array('script', 'iframe', 'frameset', 'input', 'textarea', 'select', 'form', 'base', 'object', 'param', 'embed', 'body', 'head', 'base', 'basefont', 'option', 'optgroup', 'meta', 'img');
